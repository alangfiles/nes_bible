...
;
L3733:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L372B:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L3735:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2CF4
;
...
;
	jmp     L372D
L3738:	lda     _sprite_frame_counter
	cmp     #$30
	bcs     L3739
;
; if (direction == LEFT)
