...
; BoxGuy1.vel_x = 0;
;
L3628:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L30BF:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L3711:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L3709:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L3713:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2CF4
;
...
;
	jmp     L370B
L3714:	lda     _sprite_frame_counter
	cmp     #$18
	bcs     L3715
;
; if (direction == LEFT)
...
;
	jmp     L370B
L3715:	lda     _sprite_frame_counter
	cmp     #$24
	bcs     L3716
;
; if (direction == LEFT)
...
;
	jmp     L370B
L3716:	lda     _sprite_frame_counter
	cmp     #$30
	bcs     L3717
;
; if (direction == LEFT)
