...
;
	ldx     #$FE
	lda     #$A0
L360D:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; old_x = BoxGuy1.x;
;
L3077:	lda     _BoxGuy1+1
	sta     _old_x+1
	lda     _BoxGuy1
	sta     _old_x
;
...
; BoxGuy1.vel_x = 0;
;
L35F1:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L30CC:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L31B7:	ldy     _projectile_index
	lda     #$00
L35E4:	sta     _projectiles_list,y
;
...
;
L36B6:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L36AE:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L36B8:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2CF0
;
...
;
	jmp     L36B0
L36BB:	lda     _sprite_frame_counter
	cmp     #$30
	bcs     L36BC
;
; if (direction == LEFT)
