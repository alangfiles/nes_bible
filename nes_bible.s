...
;
	ldx     #$FE
	lda     #$A0
L3684:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; old_x = BoxGuy1.x;
;
L3099:	lda     _BoxGuy1+1
	sta     _old_x+1
	lda     _BoxGuy1
	sta     _old_x
;
...
; BoxGuy1.vel_x = 0;
;
L365F:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L30EE:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L31E5:	ldy     _projectile_index
	lda     #$00
L3652:	sta     _projectiles_list,y
;
...
;
L374C:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L3744:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L374E:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2D02
;
...
;
	jmp     L3746
L374F:	lda     _sprite_frame_counter
	cmp     #$18
	bcs     L3750
;
; if (direction == LEFT)
...
;
	jmp     L3746
L3750:	lda     _sprite_frame_counter
	cmp     #$24
	bcs     L3751
;
; if (direction == LEFT)
