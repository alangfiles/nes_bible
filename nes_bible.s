...
;
	ldx     #$FE
	lda     #$A0
L35CC:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; old_x = BoxGuy1.x;
;
L3076:	lda     _BoxGuy1+1
	sta     _old_x+1
	lda     _BoxGuy1
	sta     _old_x
;
...
; BoxGuy1.vel_x = 0;
;
L35B0:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L30CB:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L31B6:	ldy     _projectile_index
	lda     #$00
L35A3:	sta     _projectiles_list,y
;
...
;
L3671:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L3669:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L3673:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2CF0
;
...
;
	jmp     L366B
L3674:	lda     _sprite_frame_counter
	cmp     #$18
	bcs     L3675
;
; if (direction == LEFT)
...
;
	jmp     L366B
L3675:	lda     _sprite_frame_counter
	cmp     #$24
	bcs     L3676
;
; if (direction == LEFT)
...
;
	jmp     L366B
L3676:	lda     _sprite_frame_counter
	cmp     #$30
	bcs     L3677
;
; if (direction == LEFT)
