...
;
	ldx     #$FE
	lda     #$A0
L3618:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; old_x = BoxGuy1.x;
;
L307B:	lda     _BoxGuy1+1
	sta     _old_x+1
	lda     _BoxGuy1
	sta     _old_x
;
...
; BoxGuy1.vel_x = 0;
;
L35F7:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L30D0:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L31BD:	ldy     _projectile_index
	lda     #$00
L35EA:	sta     _projectiles_list,y
;
...
;
L36D8:	inc     _sprite_frame_counter
;
; if (invul_frames > 0)
;
	lda     _invul_frames
...
;
	lda     #$0F
L36D0:	sta     _player_on_ladder_pose
;
; oam_meta_spr(temp_x, temp_y, tempint);
;
	jsr     decsp2
...
;
L36DA:	lda     _player_on_ladder_pose
	cmp     #$1E
	bcs     L2CF4
;
...
;
	jmp     L36D2
L36DB:	lda     _sprite_frame_counter
	cmp     #$18
	bcs     L36DC
;
; if (direction == LEFT)
...
;
	jmp     L36D2
L36DC:	lda     _sprite_frame_counter
	cmp     #$24
	bcs     L36DD
;
; if (direction == LEFT)
...
;
	jmp     L36D2
L36DD:	lda     _sprite_frame_counter
	cmp     #$30
	bcs     L36DE
;
; if (direction == LEFT)
